...
Shader::Shader(const char* vertexPath, const char* fragmentPath, const char* geometryPath, const char* controlPath, const char* evaluationPath)
{
	...
	try
	{
		...
		std::stringstream vShaderStream, fShaderStream, cShaderStream, eShaderStream;
